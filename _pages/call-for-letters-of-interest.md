...
The ECSA Steering Committee now invites the submission of Letters of Interest to organize ECSA in September 2027 and onwards. More information about the conference organization can be found at the [ECSA Charter](/assets/docs/ECSA-Steering_Committee_Charter-v2025-12-03.pdf). Also, Organizing Committees must adhere to the [ECSA rulebook](/assets/docs/ECSA-rulebook-v1.1.pdf).
